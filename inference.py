...
# Realiza el calentamiento del modelo entrenando en lotes de imágenes,
# calculando y registrando las pérdidas, y ajustando los pesos
# mediante un optimizador y un programador de tasa de aprendizaje
def warm_up(
...
# Realiza la evaluación del modelo durante una época, generando predicciones
# sobre el conjunto de validación, calculando métricas de rendimiento, 
# y registrando los resultados. La evaluación considera diferentes clases
# en función de si se trata de vasos hepáticos o no.
@torch.no_grad()
def val_one_epoch(
    model: torch.nn.Module,
    config: EasyDict,
...
# Configuración y ejecución principal del entrenamiento y evaluación del modelo.
# Se carga la configuración desde un archivo YAML, se inicializan los datos,
# se establecen las funciones de pérdida y las métricas, y se prepara el modelo
# para la inferencia y validación, incluyendo el calentamiento y la evaluación 
# en una época, registrando el rendimiento del modelo.
